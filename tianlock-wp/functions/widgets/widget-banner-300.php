...
class tianlock_wp_300px extends WP_Widget {
     function __construct() {
	    $widget_ops = array('description' => esc_html__('Advertisement - Paste your HTML or JavaScript code.', 'tianlock-wp'));
        parent::__construct(false, $name = ''. esc_html__('Custom: Advertisement 300px', 'tianlock-wp') .'',$widget_ops); 
    }
...
<?php  } }
add_action('widgets_init', create_function('', 'return register_widget("tianlock_wp_300px");')); // register widget
?>